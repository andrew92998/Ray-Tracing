...
public class OpaqueSphere implements Interactable {
	...
	public OpaqueSphere(double[] center, double radius, double rIndex, double light, World w) {
		this.center = center;
		this.radius = radius;
		this.rIndex = rIndex;
		this.light = light;
	...
	public OpaqueSphere(double x, double y, double z, double r, double rIndex, double light, World w) {
		this.radius = r;
